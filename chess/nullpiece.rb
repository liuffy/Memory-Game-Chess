...
class NullPiece
  ...
  # If I changed an instance variable (say, @color = :white) on one instance,
  # I would affect all the other NullPiece instances(and get the same @color).
  # Imagine if every empty square had a different instance of NullPiece.
